        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 rounded-xl border bg-card/50">
              ...
              <div className="overflow-hidden"><p className="text-xs text-muted-foreground font-medium">Email Support</p><p className="text-sm font-semibold truncate">support@rentnest.com</p></div>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-xl border bg-card/50">
              <Phone className="h-5 w-5 text-primary shrink-0" />
              <div><p className="text-xs text-muted-foreground font-medium">Hotline Desk</p><p className="text-sm font-semibold">+1 (555) 736-8637</p></div>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-xl border bg-card/50">
              <MapPin className="h-5 w-5 text-primary shrink-0" />
              <div><p className="text-xs text-muted-foreground font-medium">Headquarters</p><p className="text-sm font-semibold">Silicon Valley, CA</p></div>
            </div>
          </div>
        </div>
